...
package org.sertiscorp.oneml.onemlcamera.tracking;
...
import org.sertiscorp.oneml.onemlcamera.classifier.SimilarityClassifier.Recognition;
...
public class MultiBoxTracker {
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      // Center bbox to canvas
      trackedPos.offset(0, (canvas.getHeight() - (rotated ? frameWidth : frameHeight)*multiplier) / 2.f);
